...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light border-bottom border-2 border-white">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="about.html" class="nav-item nav-link">Consultation</a>
                        <a href="service.html" class="nav-item nav-link">Scholarships</a>
                        <a href="project.html" class="nav-item nav-link">Student Guide</a>
            ...
            <div class="row g-5 align-items-center mb-5">
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel header-carousel animated fadeIn">
                        <img class="img-fluid" src="img/hero-slider-1.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row g-5 align-items-center text-center">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h4>Always Up-to-Date Opportunities</h4>
                    <p class="mb-0">We update scholarship information daily so you’ll never miss an important opportunity for your future.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <i class="fa fa-tasks fa-5x text-primary mb-4"></i>
                    <h4>User-Friendly Interface</h4>
                    <p class="mb-0">Designed for simplicity — explore, filter, and apply for scholarships effortlessly.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <i class="fa fa-pencil-ruler fa-5x text-primary mb-4"></i>
                    <h4>Innovative Learning</h4>
                    <p class="mb-0">Scholar Seek combines technology and education to make scholarship searching a part of your learning journey.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <i class="fa fa-user fa-5x text-primary mb-4"></i>
                    <h4>Customer Satisfaction</h4>
                    <p class="mb-0">Your success is our priority. We’re committed to helping you find scholarships easily and confidently.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <i class="fa fa-hand-holding-usd fa-5x text-primary mb-4"></i>
                    <h4>Budget Friendly</h4>
                    <p class="mb-0">Scholar Seek is designed to help students without extra costs — because chasing education shouldn’t be expensive.</p>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <i class="fa fa-check fa-5x text-primary mb-4"></i>
                    <h4>Sustainable Learning</h4>
                    <p class="mb-0">We support continuous growth by helping students access scholarships that encourage lifelong education.</p>
                </div>
            </div>
        </div>
    </div> -->
        ...
        <div class="container mt-5">
            <div class="row g-0">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <!-- Tombol Aksi -->
                    <a href="beasiswa.html" class="btn btn-light py-3 px-5 fw-bold rounded-pill">
                ...
                <div class="col-lg-7">
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="img/project-4.png" alt="">
                                <a class="project-overlay text-decoration-none" href="#!">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.7s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="img/project-6.png" alt="">
                                <a class="project-overlay text-decoration-none" href="#!">
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.2s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="img/Service-1.png" alt="">
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.4s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="img/Service-2.png" alt="">
                                    <h3>Kumpulan Esai</h3>
                                </a>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.6s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="img/Service-3.png" alt="">
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.8s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="#!" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="img/service-44.png" alt="">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="team-item position-relative overflow-hidden">
                        ...
                        <div class="team-overlay">
                            <small class="mb-2">Education Consultant</small>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="team-item position-relative overflow-hidden">
                        ...
                        <div class="team-overlay">
                            <small class="mb-2">Career Guidance Expert</small>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="team-item position-relative overflow-hidden">
                        ...
                        <div class="team-overlay">
                            <small class="mb-2">Student Success Coach</small>
                            ...
                            <div class="row g-5 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
                                        ...
                                        <p>Pelajaranya bagus banget bro aselii</p>
    ...
    <!-- Testimonial End -->
     ...
     <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center wow fadeIn" data-wow-delay="0.1s">
                <h1 class="mb-5">Our <span class="text-uppercase text-primary bg-light px-2">Pricing</span> Plan
                </h1>
            </div>
            <div class="table-responsive wow fadeIn" data-wow-delay="0.3s">
                <table class="table table-bordered table-striped text-center align-middle" style="min-width: 700px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" class="text-start">Video Call group (10-15 mentee)</th>
                            <td>2 jam per sesi</td>
                            <td>X</td>
                            <td>X</td>
                            <td>X</td>
                        </tr>
                        <tr>
                            <th scope="row" class="text-start">Video Call 1 on 1</th>
                            <td>X</td>
                            <td>2 jam per sesi</td>
                            <td>16 jam</td>
                            <td>30 jam</td>
                        ...
                        <tr>
                            <th scope="row" class="text-start">Dokumen Review</th>
                            <td>1x</td>
                            <td>2x</td>
                            <td>16x</td>
                            <td>30x</td>
                        ...
                        <tr>
                            ...
                            <td>X</td>
                            <td>X</td>
                            <td>Unlimited selama 3 bulan</td>
                            <td>Unlimited selama 6 bulan</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="container p-0">
            <div class="row g-0 align-items-center">
                ...
                <div class="col-md-7 py-5 newsletter-text wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-5">
                        <h1 class="mb-5">Langganan untuk cari <span
                                class="text-uppercase text-primary bg-white px-2">Mentor</span></h1>
