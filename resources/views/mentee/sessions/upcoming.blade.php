    ...
    <div class="container py-5">
        <div class="row g-3 justify-content-center">
            <div class="col-12 text-center">
                <h1 class="display-1 mb-0 animated zoomIn text-black">Jadwal Belajar</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row g-4">
                ...
                <div class="card h-100 shadow-sm border-0 overflow-hidden">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0"><i class="bi bi-clock-fill text-primary"></i></div>
                            <div class="ms-3">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <div class="flex-shrink-0"><i class="bi bi-person-badge-fill text-primary"></i></div>
                            <div class="ms-3">
                        ...
                        <div class="mb-4">
                            ...
                            @else
                                <span class="badge bg-info text-white w-100 py-2">Terjadwal (Akan Datang)</span>
                            @endif
                        </div>
                    ...
                    <div class="card-footer bg-white border-0 p-4 pt-0">
                        ...
                        @elseif($status == 'ongoing' && !$hasUrl)
                            <button class="btn btn-warning w-100 py-2 fw-bold" disabled>
        ...
        @empty
            <div class="col-12 text-center py-5">
                <div class="mb-4"><i class="bi bi-calendar-x text-muted" style="font-size: 4rem;"></i></div>
                <h3 class="text-dark">Belum ada jadwal sesi untukmu.</h3>
                <p class="text-muted mx-auto" style="max-width: 500px;">Mentor akan segera menjadwalkan sesi bimbingan.</p>
            </div>
        @endforelse
    </div>
</div>
...
<style>
    .hover-push:hover { transform: translateY(-2px); transition: all 0.3s ease; }
